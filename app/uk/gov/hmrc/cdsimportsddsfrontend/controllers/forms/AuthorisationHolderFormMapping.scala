...
object AuthorisationHolderFormMapping extends FormValidators {
  val authorisationHolders: (String, Mapping[Seq[AuthorisationHolder]]) = "authorisationHolder" -> seq(mapping(
